...
public abstract class AbsPopupComponent<T> extends AbsComponent<T> implements IPopup<T> {
  ...
  public T shouldNotBeVisible() {
    assertTrue(waiter
      .waitForCondition(ExpectedConditions.invisibilityOfElementLocated(getComponentLocator())));
    return (T) this;
  }
  ...
  public T shouldBeVisible() {
    assertTrue(waiter
      .waitForCondition(ExpectedConditions.visibilityOfAllElementsLocatedBy(getComponentLocator())));
    return (T) this;
  }
